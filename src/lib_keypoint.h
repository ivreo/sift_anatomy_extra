...
struct keypoint
{
    _myfloat x; // coordinates
    _myfloat y;
    _myfloat sigma; // level of blur (it includes the assumed image blur)
    _myfloat theta; // orientation
    ...
    _myfloat val;      // operator value 
    _myfloat edgeResp; // edge response
    ...
    _myfloat* orihist; // gradient orientation histogram
