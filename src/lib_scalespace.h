...
struct octa{
    _myfloat delta;       /* sampling rate in this octave */
    int w;             /* the same for all images in the stack */
    int h;
    int nSca;          /* number of images in the stack */
    _myfloat* sigmas;     /* intrinsic levels of blur */
    _myfloat* imStack;    /* stack of nSca images of w*h samples (indexed from fine to coarse)*/
};
...
struct sift_scalespace* sift_malloc_scalespace(int nOct, const _myfloat* deltas, const int* ws, const int* hs, const int* nScas, _myfloat** sigmas);
...
struct sift_scalespace* sift_malloc_scalespace_lowe(int nOct,  /* # of octaves  */
                                         ...
                                         _myfloat delta_min,     /* minimal inter-sample distance */
